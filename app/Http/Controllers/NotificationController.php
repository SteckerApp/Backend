...
class NotificationController extends Controller
{
    ...
    {
        $notifications = Notification::with(['message.attachment', 'commenter', 'project.uploadedFiles'])->where([
    ...
    public function store($data)
    {
        ...
        $notification = Notification::with(['message.attachment', 'commenter', 'project.uploadedFiles'])->find($notification->id);
