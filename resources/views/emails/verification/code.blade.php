                        ...
                        <td style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
                            <div style="font-family: sans-serif">
                                <div class="txtTinyMce-wrapper" style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                    <p style="margin: 0; font-size: 16px; text-align: center;"><span style="font-size:30px;color:#2b303a;"><strong>Email Verification</strong></span></p>
                                </div>
                            </div>
                        </td>
                    </tr>
                        ...
                        <td style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
                            <div style="font-family: sans-serif">
                                <div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                    ...
                                    <p style="margin: 0; font-size: 15px; mso-line-height-alt: 22.5px;"><span style="font-size:15px;">We can’t wait for you to start using {{ config('app.name') }} and seeing results in your business.</span></p>
                                    <p style="margin: 0; font-size: 15px; mso-line-height-alt: 22.5px;"><span style="font-size:15px;">Please verify your email address by copy the code below, the code expire in the next 10 minutes<br></span></p>
                                    <p style="margin: 0; font-size: 15px; mso-line-height-alt: 22.5px;"><span style="font-size:40px;"><h2>OTP: {{ $code }}</h2></span></p>
                                    <p style="margin: 0; font-size: 15px; mso-line-height-alt: 22.5px;"><span style="font-size:15px;">Want to get more out of {{ config('app.name') }} by choosing a plan that fits your needs</span></p>
